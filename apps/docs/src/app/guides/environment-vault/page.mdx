...
Store, organize, and manage environment variables for each project environment. All values are end-to-end encrypted — encrypted in your browser before they reach the server, and decrypted only on your device. See [Encryption & Security](/guides/encryption) for details.
