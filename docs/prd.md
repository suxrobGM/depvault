...
| Vault duplication                  | Duplicate an existing vault (keys, values, descriptions, required flags, directory path, tags) into a new vault; secret files are not copied                                          |
